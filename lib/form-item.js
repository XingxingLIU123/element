  ...
  methods: {
    validate: function validate(trigger) {
      ...
      validator.validate(model, { firstFields: true }, function (errors, invalidFields) {
        if (errors && _typeof(errors[0].message) === "object") {
          _this.validateState = 'message';
          _this.validateMessage = errors[0].message.msg;
          callback(errors[0].message, null);
          _this.elForm && _this.elForm.$emit('validate', _this.prop, true);
        } else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_form_item_vue__ = __webpack_require__(128);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1c67b5ad_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_form_item_vue__ = __webpack_require__(285);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1c67b5ad_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_form_item_vue__["a" /* default */],
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"el-form-item",class:[{
    ...
    'is-message': _vm.validateState === 'message',
  ...
  _vm.sizeClass ? 'el-form-item--' + _vm.sizeClass : ''
        ...
        }},[_vm._v("\n        "+_vm._s(_vm.validateMessage)+"\n      ")]):_vm._e(),(_vm.validateState === 'message')?_c('div',{staticClass:"el-form-item__message",class:{
          'el-form-item__error--inline': typeof _vm.inlineMessage === 'boolean'
            ? _vm.inlineMessage
            : (_vm.elForm && _vm.elForm.inlineMessage || false)
        }},[_vm._v("\n        "+_vm._s(_vm.validateMessage)+"\n      ")]):_vm._e()])],2)])}
